...
const MoviesList: React.FC<Props> = ({ movie }: Props) => {
  ...
  return (
    <motion.div
      ...
      className="relative group-hover:opacity-70 cursor-pointer items-center px-2 py-2 rounded-md hover:bg-blue-400"
    >
      {movie.backdrop_path || movie.poster_path ? (
        ...
        >
          <Image
            ...
            width={500}
            height={500}
            className="md:h-[350px] md:min-w-[200px] object-cover"
            loading="lazy"
          />
          {isHover && (
            <>
